...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .team-name { font-family:var(--font-display); font-size:1.3rem; color: var(--heading-color); font-weight:600; margin-bottom:0.5rem; }
        .team-role { font-size:0.95rem; color:var(--text-color); margin-bottom:1rem; }
        .social-buttons { display:flex; justify-content:center; gap:1rem; margin-top:0.5rem; }
        .social-button { color:var(--text-color); font-size:1.2rem; padding:0.5rem; border-radius:50%; transition:all 0.3s; border:1px solid var(--border-blue); display:flex; align-items:center; justify-content:center;}
        .social-button.github:hover { background-color:#333; border-color:#333; color:#fff; }
        .social-button.linkedin:hover { background-color:#0a66c2; border-color:#0a66c2; color:#fff; }
    ...
    <section id="areas" class="areas-section">
        ...
        <div class="areas-grid">
            <div class="area-card">
                ...
                <h3 class="area-title">Programação</h3>
                <p class="area-description">Oficinas de desenvolvimento web, algoritmos e lógica de programação.</p>
            </div>
            <div class="area-card coming-soon-area">
                <div class="area-icon"><i class="fas fa-robot"></i></div>
                <h3 class="area-title">Robótica</h3>
                <p class="area-description">Aprenda conceitos de robótica e automação (em breve).</p>
        ...
        <div class="team-grid">
            <div class="team-card">
                <div class="team-image-container">
                    <img src="{{ asset('images/membro1.jpg') }}" alt="Membro 1" class="team-image">
                    <div class="tech-border"></div>
                </div>
                <h3 class="team-name">Jhenifer Ferreira</h3>
                <p class="team-role">Desenvolvedora Full Stack</p>
                <div class="social-buttons">
                    <a href="https://github.com" class="social-button github"><i class="fab fa-github"></i></a>
                    <a href="https://linkedin.com" class="social-button linkedin"><i class="fab fa-linkedin"></i></a>
                </div>
            </div>
        </div>
    </section>
