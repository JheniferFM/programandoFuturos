...
<div class="trilha-container">
    ...
    <div class="trilha-header">
        <h1 class="trilha-title">Trilha de Desenvolvimento Front-end</h1>
        <a href="/" class="back-button"><i class="fas fa-arrow-left"></i> Voltar</a>
    </div>

    <div class="trilha-description">
        <h2>Sobre esta trilha</h2>
        <p>Bem-vindo à trilha de Desenvolvimento Front-end! Aqui você aprenderá a criar interfaces web modernas e responsivas utilizando as tecnologias mais recentes do mercado.</p>
        <p>Esta trilha é ideal para iniciantes que desejam ingressar no mundo do desenvolvimento web, focando na parte visual e interativa das aplicações.</p>
        <p>O desenvolvimento front-end é responsável por toda a parte visual e interativa de um site ou aplicação web. É o que o usuário vê e com o que interage diretamente. Um bom desenvolvedor front-end combina habilidades técnicas com princípios de design para criar experiências digitais atraentes e funcionais.</p>
        <h3>O que você vai aprender:</h3>
        <ul>
            <li>Estruturação de páginas com HTML semântico</li>
            <li>Estilização avançada com CSS moderno</li>
            <li>Programação interativa com JavaScript</li>
            <li>Frameworks e bibliotecas populares do mercado</li>
            <li>Técnicas de design responsivo e acessibilidade</li>
        </ul>
    </div>
