...
<div class="trilha-container">
    ...
    <div class="modules-container">
        <div class="module-card">
            ...
            <p>Aprenda sobre conceitos, ecossistema Android/IOS e a configurar seu ambiente</p>
            <a href="#" class="module-button">Iniciar Módulo</a>
        </div>

        <div class="module-card">
            <span class="module-number">2</span>
            <h3>Introdução ap React Native/Flutter</h3>
            <p>Aprenda a criar interfaces móveis com React Native, componentes, navegação e consumo de APIs</p>
            <a href="#" class="module-button">Iniciar Módulo</a>
        </div>

        <div class="module-card">
            <span class="module-number">3</span>
            <h3>Integração com Backend e Banco de dados</h3>
            <p>Conecte seus apps a uma API real, trabalher com autenticação, persistencia e CRUD de dados.</p>
            <a href="#" class="module-button">Iniciar Módulo</a>
        </div>

        <div class="module-card">
            <span class="module-number">4</span>
            <h3>Publicação e Otimização de Aplicativos</h3>
            <p>Prepare seu app apra produção, otimize desempenho e publique ma Google Play ou App Store</p>
            <a href="#" class="module-button">Iniciar Módulo</a>
        </div>
    </div>
